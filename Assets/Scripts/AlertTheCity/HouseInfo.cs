...
//    //[SerializeField] int horseNumber = 0;
//    //[SerializeField] int petNumber = 0;
//    //public int kidNumber = 0;
//    //public CarSpeed carSpeed = CarSpeed.medium;
//    public List<HouseChoice> choices = new List<HouseChoice> ();
//    HouseStructure owner;
//    // Start is called before the first frame update
    

//    public HouseInfo(HouseType type, HouseStructure owner = null)
//    {
//        this.owner = owner;
//        InitHouseInfo(type);
//    }
...
//                var choice = new HouseChoice(text);
//                choices.Add(choice);
//            }
//            else
//            {
//                normalOptions.Add(menuInfo[i]);
//                var choice = new HouseChoice(menuInfo[i]);
//                choices.Add(choice);
//            }
//        }
...
//    void InitHouseInfoForType(HouseType type)
//    {
...
//        }
//    }
//    public int ReturnNumberOfChoices()
//    {
//        return normalOptions.Count + lockedOptions.Count;
//    }
